...
/**
 * Next.js-only comprehensive masters CRUD tests.
 * These use DB fixture setup, shadcn sidebar data-attributes,
 * and detailed dialog interactions that are specific to the Next.js app.
 */
...
async function gotoMaster(page: Page, slug: string, segment: string) {
  await page.goto(`/${slug}/masters/${segment}`)
}
...
test.describe("Masters CRUD — Account Groups", () => {
...
test.describe("Masters CRUD — Accounts", () => {
  test.beforeEach(async ({ page }) => {
...
test.describe("Masters CRUD — Voucher Types", () => {
  test.beforeEach(async ({ page }) => {
...
test.describe("Masters CRUD — Parties", () => {
  test.beforeEach(async ({ page }) => {
...
test.describe("Masters CRUD — Items", () => {
  test.beforeEach(async ({ page }) => {
...
test.describe("Masters CRUD — Units of Measure", () => {
  test.beforeEach(async ({ page }) => {
...
test.describe("Masters CRUD — Locations", () => {
  test.beforeEach(async ({ page }) => {
...
// ---------------------------------------------------------------------------
// Cross-cutting: sidebar navigation (Next.js specific — uses data-sidebar attrs)
// ---------------------------------------------------------------------------

test.describe("Masters sidebar navigation (Next.js)", () => {
